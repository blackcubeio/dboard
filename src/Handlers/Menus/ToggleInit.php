...
final class ToggleInit extends AbstractPanel
{
    ...
    protected function getTitle(): string { return $this->translator->translate('Modify menu', category: 'dboard-content'); }
    ...
    protected function getMessage(): string
    {
        ...
        return $this->translator->translate('Menu "{name}" will be {status}.', ['name' => $this->getModelName(), 'status' => $status], 'dboard-content');
    }
