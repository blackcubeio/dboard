...
final class DeleteInit extends AbstractPanel
{
    ...
    protected function getTitle(): string { return $this->translator->translate('Delete menu', category: 'dboard-content'); }
    protected function getContentView(): string { return 'Commons/_delete-content'; }
    protected function getMessage(): string { return $this->translator->translate('Menu "{name}" will be permanently deleted.', ['name' => $this->getModelName()], 'dboard-content'); }
