...
/**
 * Administrator toggle init action (GET).
...
final class ToggleInit extends AbstractPanel
{
    ...
    protected function getTitle(): string { return $this->translator->translate('Modify administrator', category: 'dboard-modules'); }
    protected function getMessage(): string
    {
        ...
        return $this->translator->translate('Administrator "{name}" will be {status}.', ['name' => $this->getModelName(), 'status' => $status], 'dboard-modules');
    }
