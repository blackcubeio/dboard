...
?>
        <main class="flex-1 p-4 sm:p-6 lg:p-8">
            <?php echo Html::form()
                ->post($urlGenerator->generate('dboard.elasticschemas.edit', ['id' => $elasticSchema->getId()]))
                ->csrf($csrf)
                ->noValidate()
                ->open(); ?>
                <?php echo Bleet::cardHeader()
                    ...
                    ->title($translator->translate('Elastic schema', category: 'dboard-modules'))
                    ->primary();
                ?>
                ...
                <div class="flex justify-end gap-4 mt-6">
                    <?php echo Bleet::a($translator->translate('Cancel', category: 'dboard-common'))
                        ...
                        ->render();
                    ?>
                    <?php if (!$elasticSchema->isBuiltin()): ?>
