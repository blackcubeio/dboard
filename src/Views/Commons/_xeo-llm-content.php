...
<?php elseif (empty($categories) === false): ?>
    <?php
    $categoryOptions = [];
    foreach ($categories as $category) {
        ...
        $categoryOptions[$category->getId()] = ($prefix !== '' ? $prefix . ' ' : '') . $name;
    }
    ?>
...
<?php else: ?>
    <p class="text-sm text-secondary-500 italic"><?php echo $translator->translate('No LLM node available.', category: 'dboard-common'); ?></p>
<?php endif; ?>
